...
export default function LyricsHomePage() {
  const releases = [
    ...
    },
    {
      ...
      songs: [
        { title: "Oh, There It Is!", slug: 'oh-there-it-is', artist: 'The Nice Girls' },
        { title: "I'll Ask Mama", slug: 'ill-ask-mama', artist: 'The Nice Girls' },
        { title: 'Return Policy', slug: 'return-policy', artist: 'The Nice Girls' },
        { title: "Sharin' Location", slug: 'sharin-location', artist: 'The Nice Girls' },
        { title: 'I Sat With That', slug: 'i-sat-with-that', artist: 'Danica Williams' },
        { title: 'Inside Voice', slug: 'inside-voice', artist: 'The Nice Girls' },
        { title: 'GIRLSGIRLSGIRLS', slug: 'girlsgirlsgirls', artist: 'The Nice Girls' },
        { title: 'Missed Me, Missed Out', slug: 'missed-me-missed-out', artist: 'The Nice Girls' },
        { title: "You Can't Top This", slug: 'you-cant-top-this', artist: 'The Nice Girls' },
